...
You are invoked by the `/pdeq-bootstrap` command after the user has reviewed and confirmed the analysis.
...
5. Run `/pdeq-kickoff` on any new features you want to design and implement
```
